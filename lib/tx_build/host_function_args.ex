defmodule Stellar.TxBuild.HostFunctionArgs do
  @moduledoc """
    `HostFunctionArgs` struct definition.
  """
  ...
  alias StellarBase.XDR.HostFunctionArgs, as: HostFunctionArgsXDR
  ...
  def to_xdr(%__MODULE__{
    ...
    HostFunctionArgsXDR.new(sc_vec, host_function_type)
  end
  ...
  def to_xdr(%__MODULE__{
    ...
    host_function_type = HostFunctionType.new(:HOST_FUNCTION_TYPE_UPLOAD_CONTRACT_WASM)

    code
    |> VariableOpaque256000.new()
    |> UploadContractWasmArgs.new()
    |> HostFunctionArgsXDR.new(host_function_type)
  end
