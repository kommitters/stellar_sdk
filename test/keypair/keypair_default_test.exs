defmodule Stellar.KeyPair.DefaultTest do
  ...
  test "valid_signature?/3 with valid signature", %{public_key: public_key, signature: signature} do
    true = Default.valid_signature?(<<0, 0, 0, 0>>, signature, public_key)
  end
  ...
  test "valid_signature?/3 with invalid signature", %{
    ...
    false = Default.valid_signature?(<<0, 0, 0, 1>>, signature, public_key)
  end
