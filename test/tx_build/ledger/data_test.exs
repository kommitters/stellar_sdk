defmodule Stellar.TxBuild.Ledger.DataTest do
  ...
  test "new/2", %{account_id: account_id, data_name: data_name} do
    %Data{account: %AccountID{account_id: ^account_id}, data_name: ^data_name} =
      Data.new(account: account_id, data_name: data_name)
  end

  test "new/2 invalid_account", %{data_name: data_name} do
    {:error, :invalid_account} = Data.new(account: "ABCD", data_name: data_name)
  end
  ...
  test "to_xdr/1", %{xdr: xdr, account_id: account_id, data_name: data_name} do
    ^xdr =
      [account: account_id, data_name: data_name]
      |> Data.new()
      |> Data.to_xdr()
  end
end
