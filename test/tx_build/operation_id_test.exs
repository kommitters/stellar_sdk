defmodule Stellar.TxBuild.OperationIDTest do
  ...
  test "new/1", %{
    ...
    %TxOperationID{
      ...
      sequence_number: ^sequence_number,
      op_num: ^op_num
    } = TxOperationID.new([source_account, sequence_number, op_num])
  end

  test "new/1 invalid operation id " do
    {:error, :invalid_operation_id} = TxOperationID.new("invalid_operation_id")
  end
  ...
  test "to_xdr/1",
    ...
    ^xdr = TxOperationID.new([source_account, sequence_number, op_num]) |> TxOperationID.to_xdr()
  end
