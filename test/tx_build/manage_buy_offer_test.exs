defmodule Stellar.TxBuild.ManageBuyOfferTest do
  use ExUnit.Case

  import Stellar.TxBuild.Utils, only: [number_to_fraction: 1]
  import Stellar.Test.XDRFixtures, only: [manage_buy_offer_op_xdr: 5]

  alias Stellar.TxBuild.{Amount, Asset, ManageBuyOffer, Price}
  ...
  test "new/2 with_invalid_attributes" do
    {:error, :invalid_operation_attributes} = ManageBuyOffer.new("ABC", "123")
  end
